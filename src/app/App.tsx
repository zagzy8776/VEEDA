...
export default function App() {
  ...
  function handleOnboardingComplete(name: string, age: number, weight: number, height: number, sex: string) { app.saveProfile({ name, age, weight, height, sex }); setOnboarded(true); }
  if (!onboarded) return <Onboarding onComplete={handleOnboardingComplete} />;
  if (!institutionalReady) return <LoginGateway onContinue={() => { localStorage.setItem('veda_session_ready', 'true'); setInstitutionalReady(true); }} />;
  return (
